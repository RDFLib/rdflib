...
class BRICK(DefinedNamespace):
    ...
    Acceleration_Time_Setpoint: URIRef  # None
    Access_Control_Equipment: URIRef  # None
    Access_Reader: URIRef  # None
    ...
    Air_Alarm: URIRef  # None
    Air_Differential_Pressure_Sensor: URIRef  # Measures the difference in pressure between two regions of air
    ...
    Air_Handling_Unit: URIRef  # None
    Air_Humidity_Setpoint: URIRef  # None
    ...
    Air_Static_Pressure_Step_Parameter: URIRef  # None
    ...
    Air_Temperature_Integral_Time_Parameter: URIRef  # None
    ...
    Air_Temperature_Step_Parameter: URIRef  # None
    Air_Wet_Bulb_Temperature_Sensor: URIRef  # None
    ...
    Automated_External_Defibrillator: URIRef  # None
    ...
    Average_Discharge_Air_Flow_Sensor: URIRef  # The computed average flow of discharge air over some interval
    ...
    Average_Supply_Air_Flow_Sensor: URIRef  # The computed average flow of supply air over some interval
    ...
    Broadcast_Room: URIRef  # A space to organize and manage a broadcast. Separate from studio
    ...
    Building_Air_Static_Pressure_Sensor: URIRef  # The static pressure of air within a building
    Building_Air_Static_Pressure_Setpoint: URIRef  # Sets static pressure of the entire building
    ...
    CO2_Differential_Sensor: URIRef  # Measures the difference between CO2 levels of inside and outside air
    ...
    CO_Differential_Sensor: URIRef  # None
    ...
    Chilled_Water_Differential_Pressure_Deadband_Setpoint: URIRef  # Sets the size of a deadband of differential pressure of chilled water
    Chilled_Water_Differential_Pressure_Integral_Time_Parameter: URIRef  # None
    Chilled_Water_Differential_Pressure_Load_Shed_Reset_Status: URIRef  # None
    Chilled_Water_Differential_Pressure_Load_Shed_Setpoint: URIRef  # None
    Chilled_Water_Differential_Pressure_Load_Shed_Status: URIRef  # None
    Chilled_Water_Differential_Pressure_Proportional_Band_Parameter: URIRef  # None
    ...
    Chilled_Water_Differential_Pressure_Step_Parameter: URIRef  # None
    ...
    Chilled_Water_Discharge_Flow_Sensor: URIRef  # Measures the rate of flow of chilled discharge water
    Chilled_Water_Discharge_Flow_Setpoint: URIRef  # Sets the target flow rate of chilled discharge water
    Chilled_Water_Flow_Sensor: URIRef  # Measures the rate of flow in a chilled water circuit
    ...
    Chilled_Water_Meter: URIRef  # A meter that measures the usage or consumption of chilled water
    ...
    Chilled_Water_Return_Flow_Sensor: URIRef  # Measures the rate of flow of chilled return water
    ...
    Chilled_Water_Static_Pressure_Setpoint: URIRef  # Sets static pressure of chilled water
    Chilled_Water_Supply_Flow_Sensor: URIRef  # Measures the rate of flow of chilled supply water
    Chilled_Water_Supply_Flow_Setpoint: URIRef  # Sets the target flow rate of chilled supply water
    ...
    Chilled_Water_System_Enable_Command: URIRef  # Enables operation of the chilled water system
    Chilled_Water_Temperature_Sensor: URIRef  # Measures the temperature of chilled water
    ...
    Common_Space: URIRef  # A class of spaces that are used by multiple people at the same time
    ...
    Condensate_Leak_Alarm: URIRef  # An alarm that indicates a leak of condensate from a cooling system
    ...
    Condenser_Water_Bypass_Valve: URIRef  # A valve installed in a bypass line of a condenser water loop
    Condenser_Water_Isolation_Valve: URIRef  # An isolation valve installed in the condenser water loop
    ...
    Condenser_Water_Temperature_Sensor: URIRef  # Measures the temperature of condenser water
    ...
    Cooling_Discharge_Air_Temperature_Deadband_Setpoint: URIRef  # Sets the size of a deadband of temperature of cooling discharge air
    Cooling_Discharge_Air_Temperature_Integral_Time_Parameter: URIRef  # None
    Cooling_Discharge_Air_Temperature_Proportional_Band_Parameter: URIRef  # None
    Cooling_Start_Stop_Status: URIRef  # None
    Cooling_Supply_Air_Flow_Setpoint: URIRef  # Sets supply air flow rate for cooling
    Cooling_Supply_Air_Temperature_Deadband_Setpoint: URIRef  # Sets the size of a deadband of temperature of supply air for cooling
    Cooling_Supply_Air_Temperature_Integral_Time_Parameter: URIRef  # None
    Cooling_Supply_Air_Temperature_Proportional_Band_Parameter: URIRef  # None
    ...
    Current_Sensor: URIRef  # Senses the amperes of electrical current passing through the sensor
    Curtailment_Override_Command: URIRef  # None
    ...
    Damper_Position_Command: URIRef  # Controls the position (the degree of openness) of a damper
    ...
    Deceleration_Time_Setpoint: URIRef  # None
    ...
    Dehumidification_Start_Stop_Status: URIRef  # None
    Deionised_Water_Conductivity_Sensor: URIRef  # Measures the electrical conductance of deionised water
    Deionised_Water_Level_Sensor: URIRef  # Measures the height/level of deionised water in some container
    ...
    Derivative_Gain_Parameter: URIRef  # None
    Derivative_Time_Parameter: URIRef  # None
    ...
    Differential_Pressure_Integral_Time_Parameter: URIRef  # None
    Differential_Pressure_Load_Shed_Status: URIRef  # None
    Differential_Pressure_Proportional_Band: URIRef  # None
    Differential_Pressure_Sensor: URIRef  # Measures the difference between two applied pressures
    ...
    Differential_Pressure_Step_Parameter: URIRef  # None
    Differential_Speed_Sensor: URIRef  # None
    ...
    Direct_Expansion_Cooling_Coil: URIRef  # None
    Direct_Expansion_Heating_Coil: URIRef  # None
    ...
    Disable_Differential_Temperature_Command: URIRef  # Disables the use of differential temperature control
    Disable_Fixed_Enthalpy_Command: URIRef  # Disables the use of fixed enthalpy control
    Disable_Fixed_Temperature_Command: URIRef  # Disables the use of fixed temperature temperature
    ...
    Discharge_Air_Duct_Pressure_Status: URIRef  # Indicates if air pressure in discharge duct is within expected bounds
    Discharge_Air_Flow_Demand_Setpoint: URIRef  # Sets the rate of discharge air flow required for a process
    Discharge_Air_Flow_High_Reset_Setpoint: URIRef  # None
    Discharge_Air_Flow_Low_Reset_Setpoint: URIRef  # None
    ...
    Discharge_Air_Humidity_Sensor: URIRef  # Measures the relative humidity of discharge air
    Discharge_Air_Humidity_Setpoint: URIRef  # Humidity setpoint for discharge air
    Discharge_Air_Smoke_Detection_Alarm: URIRef  # None
    Discharge_Air_Static_Pressure_Deadband_Setpoint: URIRef  # Sets the size of a deadband of static pressure of discharge air
    Discharge_Air_Static_Pressure_Integral_Time_Parameter: URIRef  # None
    Discharge_Air_Static_Pressure_Proportional_Band_Parameter: URIRef  # None
    Discharge_Air_Static_Pressure_Sensor: URIRef  # The static pressure of air within discharge regions of an HVAC system
    Discharge_Air_Static_Pressure_Setpoint: URIRef  # Sets static pressure of discharge air
    Discharge_Air_Static_Pressure_Step_Parameter: URIRef  # None
    ...
    Discharge_Air_Temperature_Cooling_Setpoint: URIRef  # Sets temperature of discharge air for cooling
    Discharge_Air_Temperature_Deadband_Setpoint: URIRef  # Sets the size of a deadband of temperature of discharge air
    Discharge_Air_Temperature_Heating_Setpoint: URIRef  # Sets temperature of discharge air for heating
    Discharge_Air_Temperature_High_Reset_Setpoint: URIRef  # None
    Discharge_Air_Temperature_Low_Reset_Setpoint: URIRef  # None
    Discharge_Air_Temperature_Proportional_Band_Parameter: URIRef  # None
    Discharge_Air_Temperature_Reset_Differential_Setpoint: URIRef  # None
    Discharge_Air_Temperature_Sensor: URIRef  # Measures the temperature of discharge air
    ...
    Discharge_Air_Temperature_Step_Parameter: URIRef  # None
    Discharge_Air_Velocity_Pressure_Sensor: URIRef  # None
    Discharge_Chilled_Water: URIRef  # None
    Discharge_Fan: URIRef  # Fan moving air discharged from HVAC vents
    Discharge_Hot_Water: URIRef  # None
    Discharge_Water: URIRef  # None
    ...
    Discharge_Water_Differential_Pressure_Integral_Time_Parameter: URIRef  # None
    Discharge_Water_Differential_Pressure_Proportional_Band_Parameter: URIRef  # None
    Discharge_Water_Flow_Sensor: URIRef  # Measures the rate of flow of discharge water
    Discharge_Water_Flow_Setpoint: URIRef  # Sets the target flow rate of discharge water
    ...
    Discharge_Water_Temperature_Proportional_Band_Parameter: URIRef  # None
    Discharge_Water_Temperature_Sensor: URIRef  # Measures the temperature of discharge water
    ...
    Domestic_Hot_Water_Supply_Temperature_Setpoint: URIRef  # Sets temperature of supplying part of domestic hot water
    ...
    Domestic_Hot_Water_System_Enable_Command: URIRef  # Enables operation of the domestic hot water system
    Domestic_Hot_Water_Temperature_Setpoint: URIRef  # Sets temperature of domestic hot water
    Domestic_Hot_Water_Valve: URIRef  # A valve regulating the flow of domestic hot water
    Domestic_Water: URIRef  # A collection of equipment that transport and regulate domestic water among each other
    Domestic_Water_Loop: URIRef  # None
    Drench_Hose: URIRef  # None
    ...
    EconCycle_Start_Stop_Status: URIRef  # None
    ...
    Effective_Air_Temperature_Cooling_Setpoint: URIRef  # None
    Effective_Air_Temperature_Heating_Setpoint: URIRef  # None
    Effective_Air_Temperature_Setpoint: URIRef  # None
    Effective_Discharge_Air_Temperature_Setpoint: URIRef  # None
    Effective_Return_Air_Temperature_Setpoint: URIRef  # None
    Effective_Room_Air_Temperature_Setpoint: URIRef  # None
    Effective_Supply_Air_Temperature_Setpoint: URIRef  # None
    Effective_Zone_Air_Temperature_Setpoint: URIRef  # None
    Electric_Baseboard_Radiator: URIRef  # Electric heating device located at or near the floor
    ...
    Electrical_Equipment: URIRef  # None
    Electrical_Meter: URIRef  # A meter that measures the usage or consumption of electricity
    Electrical_Power_Sensor: URIRef  # Measures the amount of instantaneous electric power consumed
    ...
    Emergency_Air_Flow_System: URIRef  # None
    Emergency_Air_Flow_System_Status: URIRef  # None
    ...
    Emergency_Power_Off_System_Activated_By_High_Temperature_Status: URIRef  # None
    Emergency_Power_Off_System_Activated_By_Leak_Detection_System_Status: URIRef  # None
    Emergency_Power_Off_System_Status: URIRef  # None
    Emergency_Push_Button_Status: URIRef  # Indicates if an emergency button has been pushed
    Emergency_Wash_Station: URIRef  # None
    ...
    Enable_Fixed_Temperature_Command: URIRef  # Enables the use of fixed temperature control
    ...
    Enable_Status: URIRef  # Indicates if a system or piece of functionality has been enabled
    Enclosed_Office: URIRef  # A space for individuals to work with walls and a door
    Energy_Generation_System: URIRef  # A collection of devices that generates electricity
    Energy_Sensor: URIRef  # Measures energy consumption
    Energy_Storage: URIRef  # Devices or equipment that store energy in its various forms
    ...
    Evaporative_Heat_Exchanger: URIRef  # None
    Even_Month_Status: URIRef  # None
    ...
    Exhaust_Air_Flow_Integral_Time_Parameter: URIRef  # None
    Exhaust_Air_Flow_Proportional_Band_Parameter: URIRef  # None
    ...
    Exhaust_Air_Stack_Flow_Deadband_Setpoint: URIRef  # Sets the size of a deadband of exhaust air stack flow
    Exhaust_Air_Stack_Flow_Integral_Time_Parameter: URIRef  # None
    Exhaust_Air_Stack_Flow_Proportional_Band_Parameter: URIRef  # None
    Exhaust_Air_Stack_Flow_Sensor: URIRef  # Measures the rate of flow of air in the exhaust air stack
    Exhaust_Air_Stack_Flow_Setpoint: URIRef  # Sets exhaust air stack flow rate
    Exhaust_Air_Static_Pressure_Proportional_Band_Parameter: URIRef  # None
    Exhaust_Air_Static_Pressure_Sensor: URIRef  # The static pressure of air within exhaust regions of an HVAC system
    ...
    Exhaust_Air_Velocity_Pressure_Sensor: URIRef  # None
    ...
    Fault_Status: URIRef  # Indicates the presence of a fault in a device, system or control loop
    ...
    Filter_Differential_Pressure_Sensor: URIRef  # Measures the difference in pressure on either side of a filter
    Filter_Reset_Command: URIRef  # None
    ...
    Fire_Safety_Equipment: URIRef  # None
    ...
    Formaldehyde_Level_Sensor: URIRef  # Measures the concentration of formaldehyde in air
    Freeze_Status: URIRef  # Indicates if a substance contained within a vessel has frozen
    ...
    Frost_Sensor: URIRef  # Senses the presence of frost or conditions that may cause frost
    ...
    Gas_System: URIRef  # None
    Gas_Valve: URIRef  # None
    ...
    Generator_Room: URIRef  # A room for electrical equipment, specifically electrical generators.
    Glycol: URIRef  # None
    ...
    Hail: URIRef  # pellets of frozen rain which fall in showers from cumulonimbus clouds.
    ...
    Heat_Exchanger_Supply_Water_Temperature_Sensor: URIRef  # Measures the temperature of water supplied by a heat exchanger
    Heat_Exchanger_System_Enable_Status: URIRef  # Indicates if the heat exchanger system has been enabled
    Heat_Recovery_Hot_Water_System: URIRef  # None
    ...
    Heating_Discharge_Air_Temperature_Deadband_Setpoint: URIRef  # Sets the size of a deadband of temperature of heating discharge air
    Heating_Discharge_Air_Temperature_Integral_Time_Parameter: URIRef  # None
    Heating_Discharge_Air_Temperature_Proportional_Band_Parameter: URIRef  # None
    Heating_Start_Stop_Status: URIRef  # None
    Heating_Supply_Air_Flow_Setpoint: URIRef  # Sets supply air flow rate for heating
    Heating_Supply_Air_Temperature_Deadband_Setpoint: URIRef  # Sets the size of a deadband of temperature of supply air for heating
    Heating_Supply_Air_Temperature_Integral_Time_Parameter: URIRef  # None
    Heating_Supply_Air_Temperature_Proportional_Band_Parameter: URIRef  # None
    Heating_Temperature_Setpoint: URIRef  # Sets temperature for heating
    Heating_Thermal_Power_Sensor: URIRef  # None
    ...
    High_CO2_Alarm: URIRef  # A device that indicates high concentration of carbon dioxide.
    High_Discharge_Air_Temperature_Alarm: URIRef  # An alarm that indicates that discharge air temperature is too high
    ...
    High_Humidity_Alarm: URIRef  # An alarm that indicates high concentration of water vapor in the air.
    ...
    High_Outside_Air_Lockout_Temperature_Differential_Parameter: URIRef  # The upper bound of the outside air temperature lockout range
    High_Return_Air_Temperature_Alarm: URIRef  # An alarm that indicates that return air temperature is too high
    ...
    Hot_Water_Baseboard_Radiator: URIRef  # Hydronic heating device located at or near the floor
    ...
    Hot_Water_Differential_Pressure_Deadband_Setpoint: URIRef  # Sets the size of a deadband of differential pressure of hot water
    Hot_Water_Differential_Pressure_Integral_Time_Parameter: URIRef  # None
    Hot_Water_Differential_Pressure_Load_Shed_Reset_Status: URIRef  # None
    Hot_Water_Differential_Pressure_Load_Shed_Status: URIRef  # None
    Hot_Water_Differential_Pressure_Proportional_Band_Parameter: URIRef  # None
    ...
    Hot_Water_Discharge_Temperature_Load_Shed_Status: URIRef  # None
    ...
    Hot_Water_Return_Flow_Sensor: URIRef  # Measures the rate of flow of hot return water
    Hot_Water_Return_Temperature_Sensor: URIRef  # Measures the temperature of water returned to a hot water system
    Hot_Water_Static_Pressure_Setpoint: URIRef  # Sets static pressure of hot air
    Hot_Water_Supply_Flow_Sensor: URIRef  # Measures the rate of flow of hot supply water
    Hot_Water_Supply_Flow_Setpoint: URIRef  # Sets the target flow rate of hot supply water
    Hot_Water_Supply_Temperature_High_Reset_Setpoint: URIRef  # None
    Hot_Water_Supply_Temperature_Load_Shed_Status: URIRef  # None
    Hot_Water_Supply_Temperature_Low_Reset_Setpoint: URIRef  # None
    Hot_Water_Supply_Temperature_Sensor: URIRef  # Measures the temperature of water supplied by a hot water system
    ...
    Humidification_Start_Stop_Status: URIRef  # None
    ...
    Humidity_Parameter: URIRef  # Parameters relevant to humidity-related systems and points
    ...
    Intake_Air_Temperature_Sensor: URIRef  # Measures air at the interface between the building and the outside
    Integral_Gain_Parameter: URIRef  # None
    Integral_Time_Parameter: URIRef  # None
    Intercom_Equipment: URIRef  # None
    Interface: URIRef  # A device that provides an occupant control over a lighting system
    Intrusion_Detection_Equipment: URIRef  # None
    ...
    Janitor_Room: URIRef  # A room set aside for the storage of cleaning equipment and supplies
    ...
    Lighting: URIRef  # None
    Lighting_Equipment: URIRef  # None
    ...
    Liquid_Detection_Alarm: URIRef  # None
    Load_Current_Sensor: URIRef  # Measures the current consumed by a load
    Load_Parameter: URIRef  # None
    Load_Setpoint: URIRef  # None
    Load_Shed_Command: URIRef  # Controls load shedding behavior provided by a control system
    Load_Shed_Differential_Pressure_Setpoint: URIRef  # None
    Load_Shed_Setpoint: URIRef  # None
    ...
    Low_Freeze_Protect_Temperature_Parameter: URIRef  # None
    Low_Humidity_Alarm: URIRef  # An alarm that indicates low concentration of water vapor in the air.
    Low_Humidity_Alarm_Parameter: URIRef  # A parameter determining the humidity level at which to trigger a low humidity alarm
    Low_Outside_Air_Lockout_Temperature_Differential_Parameter: URIRef  # The lower bound of the outside air temperature lockout range
    Low_Outside_Air_Temperature_Enable_Differential_Sensor: URIRef  # None
    Low_Outside_Air_Temperature_Enable_Setpoint: URIRef  # None
    Low_Return_Air_Temperature_Alarm: URIRef  # An alarm that indicates that return air temperature is too low
    ...
    Luminance_Alarm: URIRef  # None
    Luminance_Command: URIRef  # Controls the amount of luminance delivered by a lighting system
    ...
    Manual_Auto_Status: URIRef  # Indicates if a system is under manual or automatic operation
    ...
    Max_Water_Level_Alarm: URIRef  # Alarm indicating that the maximum water level was reached
    Max_Water_Temperature_Setpoint: URIRef  # Setpoint for max water temperature
    Measurable: URIRef  # None
    Mechanical_Room: URIRef  # A class of service rooms where mechanical equipment (HVAC) operates
    ...
    Medium_Temperature_Hot_Water_Differential_Pressure_Load_Shed_Reset_Status: URIRef  # None
    Medium_Temperature_Hot_Water_Differential_Pressure_Load_Shed_Setpoint: URIRef  # None
    Medium_Temperature_Hot_Water_Differential_Pressure_Load_Shed_Status: URIRef  # None
    ...
    Medium_Temperature_Hot_Water_Differential_Pressure_Setpoint: URIRef  # None
    Medium_Temperature_Hot_Water_Discharge_Temperature_High_Reset_Setpoint: URIRef  # None
    Medium_Temperature_Hot_Water_Discharge_Temperature_Low_Reset_Setpoint: URIRef  # None
    ...
    Medium_Temperature_Hot_Water_Supply_Temperature_High_Reset_Setpoint: URIRef  # None
    Medium_Temperature_Hot_Water_Supply_Temperature_Load_Shed_Setpoint: URIRef  # None
    Medium_Temperature_Hot_Water_Supply_Temperature_Load_Shed_Status: URIRef  # None
    Medium_Temperature_Hot_Water_Supply_Temperature_Low_Reset_Setpoint: URIRef  # None
    ...
    Min_Water_Level_Alarm: URIRef  # Alarm indicating that the minimum water level was reached
    ...
    Mode_Status: URIRef  # Indicates which mode a system, device or control loop is currently in
    ...
    Motor_On_Off_Status: URIRef  # None
    Motor_Speed_Sensor: URIRef  # None
    ...
    Network_Video_Recorder: URIRef  # None
    No_Water_Alarm: URIRef  # Alarm indicating that there is no water in the equipment or system
    ...
    Occupied_Air_Temperature_Setpoint: URIRef  # None
    Occupied_Cooling_Discharge_Air_Flow_Setpoint: URIRef  # Sets discharge air flow for cooling when occupied
    Occupied_Cooling_Supply_Air_Flow_Setpoint: URIRef  # Sets supply air flow rate for cooling when occupied
    Occupied_Cooling_Temperature_Deadband_Setpoint: URIRef  # Sets the size of a deadband of temperature for cooling when occupied
    Occupied_Discharge_Air_Flow_Setpoint: URIRef  # Sets discharge air flow when occupied
    Occupied_Discharge_Air_Temperature_Setpoint: URIRef  # None
    Occupied_Heating_Discharge_Air_Flow_Setpoint: URIRef  # Sets discharge air flow for heating when occupied
    Occupied_Heating_Supply_Air_Flow_Setpoint: URIRef  # Sets supply air flow rate for heating when occupied
    Occupied_Heating_Temperature_Deadband_Setpoint: URIRef  # Sets the size of a deadband of temperature for heating when occupied
    Occupied_Mode_Status: URIRef  # Indicates if a system, device or control loop is in "Occupied" mode
    Occupied_Return_Air_Temperature_Setpoint: URIRef  # None
    Occupied_Room_Air_Temperature_Setpoint: URIRef  # None
    Occupied_Supply_Air_Flow_Setpoint: URIRef  # Sets supply air flow rate when occupied
    Occupied_Supply_Air_Temperature_Setpoint: URIRef  # None
    Occupied_Zone_Air_Temperature_Setpoint: URIRef  # None
    ...
    On_Off_Status: URIRef  # Indicates the on/off status of a control loop, relay or equipment
    ...
    Open_Heating_Valve_Outside_Air_Temperature_Setpoint: URIRef  # None
    ...
    Output_Frequency_Sensor: URIRef  # None
    Output_Voltage_Sensor: URIRef  # Measures the voltage output by some process or device
    Outside: URIRef  # None
    ...
    Outside_Air_Dewpoint_Sensor: URIRef  # Senses the dewpoint temperature of outside air
    Outside_Air_Enthalpy_Sensor: URIRef  # Measures the total heat content of outside air
    Outside_Air_Flow_Sensor: URIRef  # Measures the rate of flow of outside air into the system
    ...
    Outside_Air_Lockout_Temperature_Differential_Parameter: URIRef  # None
    Outside_Air_Lockout_Temperature_Setpoint: URIRef  # None
    Outside_Air_Temperature_Enable_Differential_Sensor: URIRef  # None
    Outside_Air_Temperature_High_Reset_Setpoint: URIRef  # None
    Outside_Air_Temperature_Low_Reset_Setpoint: URIRef  # None
    ...
    Outside_Air_Wet_Bulb_Temperature_Sensor: URIRef  # A sensor measuring the wet-bulb temperature of outside air
    ...
    Outside_Illuminance_Sensor: URIRef  # Measures the total luminous flux incident on an outside, per unit area
    Overload_Alarm: URIRef  # An alarm that can indicate when a full-load current is exceeded.
    ...
    PV_Array: URIRef  # None
    PV_Current_Output_Sensor: URIRef  # See Photovoltaic_Current_Output_Sensor
    PV_Generation_System: URIRef  # A collection of photovoltaic devices that generates energy
    ...
    Parking_Structure: URIRef  # A building or part of a building devoted to vehicle parking
    ...
    Peak_Power_Demand_Sensor: URIRef  # The peak power consumed by a process over some period of time
    ...
    Preheat_Discharge_Air_Temperature_Sensor: URIRef  # Measures the temperature of discharge air before heating is applied
    Preheat_Hot_Water_System: URIRef  # None
    Preheat_Hot_Water_Valve: URIRef  # None
    Preheat_Supply_Air_Temperature_Sensor: URIRef  # Measures the temperature of supply air before it is heated
    ...
    Private_Office: URIRef  # An office devoted to a single individual, with walls and door
    Proportional_Band_Parameter: URIRef  # None
    Proportional_Gain_Parameter: URIRef  # None
    ...
    Radiation_Hot_Water_System: URIRef  # None
    Radiator: URIRef  # Heat exchangers designed to transfer thermal energy from one medium to another
    Radioactivity_Concentration_Sensor: URIRef  # Measures the concentration of radioactivity
    Radon_Concentration_Sensor: URIRef  # Measures the concentration of radioactivity due to radon
    Rain_Duration_Sensor: URIRef  # Measures the duration of precipitation within some time frame
    ...
    Reheat_Hot_Water_System: URIRef  # None
    ...
    Remotely_On_Off_Status: URIRef  # None
    Reset_Command: URIRef  # Commands that reset a flag, property or value to its default
    ...
    Return_Air_Differential_Pressure_Sensor: URIRef  # Measures the difference in pressure between the return and supply side
    ...
    Return_Air_Temperature_High_Reset_Setpoint: URIRef  # None
    Return_Air_Temperature_Low_Reset_Setpoint: URIRef  # None
    ...
    Return_Condenser_Water_Flow_Sensor: URIRef  # Measures the flow of the return condenser water
    Return_Condenser_Water_Temperature_Sensor: URIRef  # Measures the temperature of the return condenser water
    Return_Condenser_Water_Temperature_Setpoint: URIRef  # The temperature setpoint for the return condenser water
    ...
    Return_Heating_Valve: URIRef  # A valve installed on the return side of a heat exchanger
    Return_Hot_Water: URIRef  # None
    Return_Hot_Water_Temperature_Setpoint: URIRef  # Sets the temperature of return (downstream of the hot water load) hot water
    Return_Water: URIRef  # The water is a system after it is used in a heat transfer cycle
    Return_Water_Flow_Sensor: URIRef  # None
    ...
    Run_Enable_Command: URIRef  # None
    Run_Request_Status: URIRef  # Indicates if a request has been filed to start a device or equipment
    Run_Status: URIRef  # None
    Run_Time_Sensor: URIRef  # Measures the duration for which a device was in an active or "on" state
    Safety_Equipment: URIRef  # None
    Safety_Shower: URIRef  # None
    Safety_System: URIRef  # None
    Sash_Position_Sensor: URIRef  # Measures the current position of a sash in terms of the percent of fully open
    Schedule_Temperature_Setpoint: URIRef  # The current setpoint as indicated by the schedule
    Security_Equipment: URIRef  # None
    Security_Service_Room: URIRef  # A class of spaces used by the security staff of a facility
    ...
    Setpoint: URIRef  # A Setpoint is an input value at which the desired property is set
    ...
    Smoke_Detection_Alarm: URIRef  # None
    ...
    Speed_Reset_Command: URIRef  # None
    ...
    Speed_Status: URIRef  # Indicates the operating speed of a device or equipment, e.g. fan
    ...
    Standby_Glycool_Unit_On_Off_Status: URIRef  # Indicates the on/off status of a standby glycool unit
    Standby_Load_Shed_Command: URIRef  # None
    ...
    Static_Pressure_Deadband_Setpoint: URIRef  # Sets the size of a deadband of static pressure
    Static_Pressure_Integral_Time_Parameter: URIRef  # None
    Static_Pressure_Proportional_Band_Parameter: URIRef  # None
    ...
    Static_Pressure_Step_Parameter: URIRef  # None
    ...
    Steam_Baseboard_Radiator: URIRef  # Steam heating device located at or near the floor
    ...
    Steam_On_Off_Command: URIRef  # None
    ...
    Steam_Valve: URIRef  # None
    Step_Parameter: URIRef  # None
    ...
    Supply_Air_Duct_Pressure_Status: URIRef  # Indicates if air pressure in supply duct is within expected bounds
    Supply_Air_Flow_Demand_Setpoint: URIRef  # Sets the rate of supply air flow required for a process
    ...
    Supply_Air_Integral_Gain_Parameter: URIRef  # None
    ...
    Supply_Air_Proportional_Gain_Parameter: URIRef  # None
    Supply_Air_Static_Pressure_Deadband_Setpoint: URIRef  # Sets the size of a deadband of static pressure of supply air
    Supply_Air_Static_Pressure_Integral_Time_Parameter: URIRef  # None
    Supply_Air_Static_Pressure_Proportional_Band_Parameter: URIRef  # None
    Supply_Air_Static_Pressure_Sensor: URIRef  # The static pressure of air within supply regions of an HVAC system
    ...
    Supply_Air_Temperature_Deadband_Setpoint: URIRef  # Sets the size of a deadband of temperature of supply air
    Supply_Air_Temperature_High_Reset_Setpoint: URIRef  # None
    Supply_Air_Temperature_Low_Reset_Setpoint: URIRef  # None
    Supply_Air_Temperature_Proportional_Band_Parameter: URIRef  # None
    Supply_Air_Temperature_Reset_Differential_Setpoint: URIRef  # None
    ...
    Supply_Air_Temperature_Step_Parameter: URIRef  # None
    Supply_Air_Velocity_Pressure_Sensor: URIRef  # None
    Supply_Chilled_Water: URIRef  # None
    Supply_Chilled_Water_Temperature_Setpoint: URIRef  # Temperature setpoint for supply chilled water
    ...
    Supply_Condenser_Water_Flow_Sensor: URIRef  # Measures the flow of the supply condenser water
    Supply_Condenser_Water_Temperature_Sensor: URIRef  # Measures the temperature of the supply condenser water
    Supply_Condenser_Water_Temperature_Setpoint: URIRef  # The temperature setpoint for the supply condenser water
    Supply_Fan: URIRef  # Fan moving supply air -- air that is supplied from the HVAC system into the building
    Supply_Hot_Water: URIRef  # None
    Supply_Hot_Water_Temperature_Setpoint: URIRef  # Temperature setpoint for supply hot water
    Supply_Water: URIRef  # None
    Supply_Water_Differential_Pressure_Deadband_Setpoint: URIRef  # Sets the size of a deadband of differential pressure of supply water
    Supply_Water_Differential_Pressure_Integral_Time_Parameter: URIRef  # None
    Supply_Water_Differential_Pressure_Proportional_Band_Parameter: URIRef  # None
    ...
    Supply_Water_Temperature_Deadband_Setpoint: URIRef  # Sets the size of a deadband of temperature of supply water
    Supply_Water_Temperature_Integral_Time_Parameter: URIRef  # None
    Supply_Water_Temperature_Proportional_Band_Parameter: URIRef  # None
    Supply_Water_Temperature_Setpoint: URIRef  # Sets temperature of supply water
    Surveillance_Camera: URIRef  # None
    ...
    TVOC_Sensor: URIRef  # None
    Team_Room: URIRef  # An office used by multiple team members for specific work tasks. Distinct from Conference Room
    Telecom_Room: URIRef  # A class of spaces used to support telecommuncations and IT equipment
    ...
    Temperature_Differential_Reset_Setpoint: URIRef  # None
    Temperature_High_Reset_Setpoint: URIRef  # None
    Temperature_Low_Reset_Setpoint: URIRef  # None
    Temperature_Parameter: URIRef  # Parameters relevant to temperature-related systems and points
    ...
    Temperature_Step_Parameter: URIRef  # None
    ...
    Thermal_Power_Sensor: URIRef  # None
    ...
    Time_Parameter: URIRef  # None
    Time_Setpoint: URIRef  # None
    ...
    Underfloor_Air_Plenum_Static_Pressure_Setpoint: URIRef  # Sets the underfloor air plenum static pressure
    Underfloor_Air_Temperature_Sensor: URIRef  # Measures the temperature of underfloor air
    Unit_Failure_Alarm: URIRef  # An alarm that indicates the failure of an equipment or device
    Unoccupied_Air_Temperature_Cooling_Setpoint: URIRef  # Sets temperature of air when unoccupied for cooling
    Unoccupied_Air_Temperature_Heating_Setpoint: URIRef  # Sets temperature of air when unoccupied for heating
    Unoccupied_Air_Temperature_Setpoint: URIRef  # Sets temperature of air when unoccupied
    Unoccupied_Cooling_Discharge_Air_Flow_Setpoint: URIRef  # Sets discharge air flow for cooling when unoccupied
    Unoccupied_Discharge_Air_Temperature_Setpoint: URIRef  # None
    Unoccupied_Load_Shed_Command: URIRef  # None
    Unoccupied_Return_Air_Temperature_Setpoint: URIRef  # None
    Unoccupied_Room_Air_Temperature_Setpoint: URIRef  # None
    Unoccupied_Supply_Air_Temperature_Setpoint: URIRef  # None
    Unoccupied_Zone_Air_Temperature_Setpoint: URIRef  # None
    ...
    Velocity_Pressure_Sensor: URIRef  # Measures the difference between total pressure and static pressure
    ...
    Vertical_Space: URIRef  # A class of spaces used to connect multiple floors or levels..
    Video_Intercom: URIRef  # None
    Video_Surveillance_Equipment: URIRef  # None
    ...
    Water_Level_Alarm: URIRef  # An alarm that indicates a high or low water level e.g. in a basin
    ...
    Water_Loss_Alarm: URIRef  # An alarm that indicates a loss of water e.g. during transport
    ...
    Wind_Direction_Sensor: URIRef  # Measures the direction of wind in degrees relative to North
    Wind_Speed_Sensor: URIRef  # Measured speed of wind, caused by air moving from high to low pressure
    ...
    Zone_Air_Cooling_Temperature_Setpoint: URIRef  # The upper (cooling) setpoint for zone air temperature
    Zone_Air_Dewpoint_Sensor: URIRef  # Measures dewpoint of zone air
    Zone_Air_Heating_Temperature_Setpoint: URIRef  # The lower (heating) setpoint for zone air temperature
    ...
    Zone_Standby_Load_Shed_Command: URIRef  # None
    Zone_Unoccupied_Load_Shed_Command: URIRef  # None
    ...
    hasLocation: URIRef  # Subject is physically located in the location given by the object
    ...
    isMeasuredBy: URIRef  # None
    isPartOf: URIRef  # None
    ...
    isRegulatedBy: URIRef  # None
    isTagOf: URIRef  # None
    latitude: URIRef  # None
    longitude: URIRef  # None
    ...
    storedAt: URIRef  # A reference to where the data for this TimeseriesReference is stored
    ...
    operationalStageCount: URIRef  # The number of operational stages supported by this eqiupment
