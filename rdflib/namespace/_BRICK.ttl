...
class BRICK(DefinedNamespace):
    ...
    PM2.5_Sensor: URIRef  # Detects matter of size 2.5 microns
    PM2.5_Level_Sensor: URIRef  # Detects level of particulates of size 2.5 microns
    PM1_Sensor: URIRef  # Detects matter of size 1 micron
    PM1_Level_Sensor: URIRef  # Detects level of particulates of size 1 microns
    PM1_Level_Sensor: URIRef  # Detects level of particulates of size 1 micron
    ...
    Limit: URIRef  # A parameter that places a lower or upper bound on the range of permitted values of a Setpoint.
    ...
    Domestic_Water: URIRef  # Tap water for drinking, washing, cooking, and flushing of toliets
    ...
    Ventilation_Air_System: URIRef  # The equipment, distribution systems and terminals that introduce or exhaust, either collectively or individually, the air used for the ventilation system of the building
    ...
    Building: URIRef  # a structure wholly or partially enclosed within exterior walls, or within exterior and party walls, and a roof, affording shelter to persons, animals, or property.
