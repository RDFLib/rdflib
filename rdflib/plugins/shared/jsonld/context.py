...
class Context:
    def __init__(
        ...
        version: Union[float, None] = 1.1,
    ):
        self.version: float = version or 1.1
        self.language = None
        self.vocab: Union[str, None] = None
        self._base: Union[str, None]
        self.base = base
        self.doc_base = base
        ...
        self.active = False
        self.parent: Union[Context, None] = None
        self.propagate = True
    ...
    @base.setter
    def base(self, base: Union[str, None]):
        if base:
    ...
    def get_context_for_type(self, node: Any) -> Union[Context, None]:
        if self.version >= 1.1:
    ...
    def find_term(
        ...
        container: Defined | Union[str, None] = UNDEF,
    ...
    def to_symbol(self, iri: str) -> Union[str, None]:
        iri = str(iri)
    ...
    def load(
        ...
        self.active = True
        sources: List[Tuple[Union[str, None], Dict[str, Any] | Union[str, None]]] = []
    ...
    def _prep_sources(
        self,
        base: Union[str, None],
        inputs: List[Dict[str, Any] | Union[str, None]] | List[str],
        sources: List[Tuple[Union[str, None], Dict[str, Any] | Union[str, None]]],
        referenced_contexts: set[str],
        in_source_url: Union[str, None] = None,
    ):
    ...
    def _fetch_context(
        self, source: str, base: Union[str, None], referenced_contexts: set[str]
    ):
    ...
    def _rec_expand(
        self, source: Dict[str, Any], expr: Union[str, None], prev: Union[str, None] = None
    ) -> Union[str, None]:
    ...
    def _prep_expand(self, expr: str) -> Tuple[bool, Union[str, None], str]:
        if ":" not in expr:
    ...
    def _get_source_id(self, source: Dict[str, Any], key: str) -> Union[str, None]:
