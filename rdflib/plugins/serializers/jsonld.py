...
from .jsonldsupport._compat import str
from .jsonldsupport.context import Context, UNDEF
from .jsonldsupport.util import json
from .jsonldsupport.keys import CONTEXT, GRAPH, ID, VOCAB, LIST, SET, LANG
...
def from_rdf(graph, context_data=None, base=None,
    ...
    if not context_data and auto_compact:
        context_data = dict(
            ...
            str(ns) != "http://www.w3.org/XML/1998/namespace")
