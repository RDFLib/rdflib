...
from rdflib.extras.sqlstore.abstractsqlstore import (
    AbstractSQLStore,
    extractTriple,
    unionSELECT,
        ...
        if home == ":memory:":
            ...
            for tblsuffix in table_name_prefixes:
                try:
                    ...
                    logging.info("unable to drop table: %s, %s" % (
            ...
            logging.info(
                "Destroyed Close World Universe %s (in SQLite db %s)" % (
