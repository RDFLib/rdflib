...
from rdflib.extras.utils.termutils import OBJECT, escape_quotes
from rdflib.plugins.stores.regexmatching import REGEXTerm
from rdflib.extras.sqlstore.foplrelationalmodel.quadslot import (
    normalizeValue,
)
...
class Table(object):
    ...
    def removeIndexingStatements(self):
        ...
        of the indices corresponding to `indexingStatements`.
        '''
        return []
