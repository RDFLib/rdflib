...
from rdflib.syntax.parsers.rdfa.literal import generate_literal
from rdflib.syntax.parsers.rdfa.embeddedrdf import handle_embeddedRDF
from rdflib.syntax.parsers.rdfa.options import GENERIC_XML, XHTML_RDFA, HTML5_RDFA
