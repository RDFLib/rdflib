...
class SPARQL :
    ...
    a superclass of the L{sparqlGraph<sparqlGraph.sparqlGraph>}
    ...
    def sparqlQuery(self,selectU,where,constraints=[],optional=[]) :
        ...
        Identifier (ie, a Literal or a URIRef). If a string and if the
        string begins by"?", it is an unbound variable, otherwise a Literal is created on the
        ...
        tweak: an element in 'where' may be a list of tuples, instead
