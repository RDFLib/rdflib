...
def infixowl_example():
    ...
    cprOntology.comment = [
        Literal("""This OWL ontology was generated by Fuxi 0.85b.dev-r107
    ...
    representationOf = Property(  # noqa: N806
        ...
        comment=[Literal("""Patient records stand in the cpr:representation-of relation
                   with patients""")],
    )
    ...
    descrOf = Property(  # noqa: N806
        CPR["description-of"],
        comment=[Literal("""Clinical descriptions stand in the cpr:description-of
    ...
    interpretedBy = Property(  # noqa: F841, N806
        CPR["interpreted-by"],
        comment=[Literal("""Signs and symptoms are interpreted by rational physical
                   objects (people)""")],
    ...
    realizedBy = Property(  # noqa: N806
        CPR["realized-by"],
        comment=[Literal("""The epistemological relation in which screening acts and
    ...
    person.comment = [
        Literal("""A class which directly corresponds with the “Person” class in
               both GALEN and Cyc""")
    ]
    ...
    patient.comment = [Literal("""A class which directly corresponds with the “Patient”
    ...
    clinician.comment = [
        Literal("""A person who plays the clinician role (typically Nurse,
    ...
    bytes.comment = [
        Literal("""The collection of physical objects which constitute a stream of
    ...
    patientRecord.comment = [
        Literal("""a class (a representational artifact [REFTERM]) depicting
    ...
    problem.comment = [
        Literal(""".. problems that clearly require the intervention of a health
    ...
    clinDescr.comment = [
        Literal("""A class which corresponds (at least syntactically) with the HL7
    ...
    sign.comment = [
        Literal("""A cpr:medical-problem which are specifically interpreted by a
    ...
    symptom.comment = [
        Literal("""(Medicine) any sensation or change in bodily function that is
