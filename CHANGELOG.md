2020/03/29 RELEASE 5.0.0
========================

After more than three years, RDFLib 5.0.0 is finally released.
...
Please see the upgrade4to5 document for more information on some specific differences from 4.2.2 to 5.0.0.
