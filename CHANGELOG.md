...
-   Add **dir** to DefinedNamespaceMeta.
...
-   Use assertTrue instead of assert\_ for python 3.11 compatibility.
...
-   Add **init** for shared jsonld module
...
-   Speedup Literal.**hash** and Literal.**eq** by accessing directly \_da…
...
-   Require setuptools, rdflib/plugins/sparql/**init**.py and rdflib/plugin.py import pkg_resources
...
-   Add tests for Graph.transitive\_{subjects,objects}
...
-   Add a **dir** attribute to a closed namespace
...
-   http://code.google.com/p/rdflib/issues/detail?id=153
    ...
    Timestamps with microseconds _and_ "Z" timezone are not parsed
...
Fixed split*uri to handle URIs with * in them properly.
...
Added missing "from **future** import generators" statement to
InformationStore.
...
Added missing "from **future** import generators" statements
