...
import io
import json
from rdflib import Graph, Dataset, RDF, RDFS, Namespace
...
class TestIssue1484_ds_json(unittest.TestCase):
    def test_issue_1484_ds_json(self):
        """
        Test JSON-LD parsing of result from json.dump
        """
        n = Namespace("http://example.org/")
...
class TestIssue1484_ds_str(unittest.TestCase):
    def test_issue_1484_ds_str(self):
        """
        Test JSON-LD parsing of result from string (used by round tripping tests)
