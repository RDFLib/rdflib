...
def test_repo_query_value_error(repo: Repository, monkeypatch: pytest.MonkeyPatch):
    mock_query = Mock()
    mock_query.algebra.name = "InvalidQueryType"
    monkeypatch.setattr(
        "rdflib.contrib.rdf4j.client.prepareQuery", lambda _: mock_query
    )
