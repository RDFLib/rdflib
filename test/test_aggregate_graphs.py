...
class GraphAggregates1(unittest.TestCase):
    ...
    def testAggregateRaw(self):
        #Test triples
        self.assertEqual(len(list(self.G.triples((None,RDF.type,None))))                 , 4)
        self.assertEqual(len(list(self.G.triples((URIRef("http://test/bar"),None,None)))), 2)
        self.assertEqual(len(list(self.G.triples((None,URIRef("http://test/d"),None))))  , 3)
