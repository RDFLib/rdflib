...
def check_entry(entry: ManifestEntry) -> None:
    ...
    with ExitStack() as xstack:
        ...
        dataset.parse(action_path, publicID=entry.action, format="larknquads")
...
MARK_DICT = {
    ...
    # f"{REMOTE_BASE_IRI}#nq-syntax-bad-uri-01": pytest.mark.xfail(
    #     reason="Accepted bad URI"
    # ),
    ...
    #    reason="Non-deterministic test, incorrect failures"
    # ),
}
